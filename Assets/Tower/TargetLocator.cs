...
public class TargetLocator : MonoBehaviour
{
    ...
    {
        // Calcular la direcci�n hacia el objetivo ignorando la diferencia en el eje Y
        ...
        // Si la direcci�n no es cero, rotar el arma
        if (direction != Vector3.zero)
        {
            // Calcular la rotaci�n hacia la direcci�n
            Quaternion lookRotation = Quaternion.LookRotation(direction);

            // Aplicar la rotaci�n al arma limit�ndola solo al eje Y
